...
| 5. 同族与法律状态 | 同族成员公开号、国家/地区、关系类型、申请/公开/授权信息、当前法律状态、法律状态事件和来源时间 | 先显示可点击同族成员清单；点击成员进入该专利自己的详情页；关系图用于补充探索；支持同族聚拢列表和比较法域 | `PatentFamily + PatentIdentifier + FamilyRelation + LegalStatusEvent` |
