...
export default function ColumnConfigPanel({ open, fields, frozenFields, onClose, onToggleVisible, onToggleFreeze, onRemove, onReorder }: ColumnConfigPanelProps) {
  ...
  return <div className="modal-overlay" onMouseDown={event => { if (event.target === event.currentTarget) onClose() }}><div className="modal" style={{ maxWidth: 760 }} onClick={event => event.stopPropagation()}>
