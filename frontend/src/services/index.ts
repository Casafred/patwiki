...
export const patentService = {
  ...
  bulkMoveDatabase: (...args: Parameters<typeof patentApi.bulkMoveDatabase>) => patentApi.bulkMoveDatabase(...args),
  bulkMoveView: (...args: Parameters<typeof patentApi.bulkMoveView>) => patentApi.bulkMoveView(...args),
  bulkDuplicate: (...args: Parameters<typeof patentApi.bulkDuplicate>) => patentApi.bulkDuplicate(...args),
